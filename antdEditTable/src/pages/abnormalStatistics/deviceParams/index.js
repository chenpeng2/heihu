        ...
        this.state = {
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: (text,row) => <div>报警<span style={{color:'#0A6ED1',margin:'0 4px'}} onClick={this.clickRow.bind(this,'0',row.equipmentNumber)}>{text}</span>次</div>,
                },
                {
                    title: '螺旋转速',
                    dataIndex: 'screwSpeed',
                    render: (text,row) => <div>报警<span style={{color:'#0A6ED1',margin:'0 4px'}} onClick={this.clickRow.bind(this,'1',row.equipmentNumber)}>{text}</span>次</div>,
                },
                {
                    title: '牵引速度',
                    dataIndex: 'tractionSpeed',
                    render: (text,row) => <div>报警<span style={{color:'#0A6ED1',margin:'0 4px'}} onClick={this.clickRow.bind(this,'2',row.equipmentNumber)}>{text}</span>次</div>,
                },
                {
                    title: '熔温',
                    dataIndex: 'fusionTemperature',
                    render: (text,row) => <div>报警<span style={{color:'#0A6ED1',margin:'0 4px'}} onClick={this.clickRow.bind(this,'3',row.equipmentNumber)}>{text}</span>次</div>,
                },
                {
                    title: '熔压',
                    dataIndex: 'fusionPressure',
                    render: (text,row) => <div>报警<span style={{color:'#0A6ED1',margin:'0 4px'}} onClick={this.clickRow.bind(this,'4',row.equipmentNumber)}>{text}</span>次</div>,
                },
                {
                    title: '1-5温区',
                    dataIndex: 'lWarmArea',
                    render: (text,row) => <div>报警<span style={{color:'#0A6ED1',margin:'0 4px'}} onClick={this.clickRow.bind(this,'5',row.equipmentNumber)}>{text}</span>次</div>,
                },
                {
                    title: '6-20温区',
                    dataIndex: 'hWarmArea',
                    render: (text,row) => <div>报警<span style={{color:'#0A6ED1',margin:'0 4px'}} onClick={this.clickRow.bind(this,'6',row.equipmentNumber)}>{text}</span>次</div>,
                },
                {
                    title: '',
                    dataIndex: 'nextGo',
