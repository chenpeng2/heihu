    ...
    render() {
        ...
        return (
            <Tabs tabPosition="left" defaultActiveKey="1">
                <TabPane 
                    tab={ <div className="tab-inner"><i className="sap-icon icon-account"></i><div>账户<div>{ user.username }</div></div></div> }
                    key="1">
                    <div className="inner" style={{ height: '460px' }}>
                        {/*<div className="title"><i className="sap-icon icon-account"></i> { user.username }</div>*/}
                        <form>
                            <div className="group">
                                <label>名称：</label>
