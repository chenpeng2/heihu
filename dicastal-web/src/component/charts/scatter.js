...
class ScatterChart extends React.Component {
    ...
    onChartReadyCallback = (chart) => {
        this.setState({chart},()=>{
            ...
            if(dd.xDimension && dd.xDimension.length){
                _this.brushSelect(dd.xDimension[0],dd.xDimension[1])
            }
    ...
    UNSAFE_componentWillReceiveProps(nextProps){
        ...
        const {startTime,endTime,clickStart,clickEnd} = chooseTime;
        ...
        if(chart){
            ...
            if(clickStart || clickEnd){
                this.brushSelect(startT,endT,'clear')
            }
        }
