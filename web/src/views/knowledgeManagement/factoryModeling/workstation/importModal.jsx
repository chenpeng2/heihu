...
import { importWorkstation } from 'services/knowledgeBase/workstation';
    ...
    parseFile({
      ...
      callback: async data => {
        ...
        for (const node of requestArr) {
          const { data } = await importWorkstation({ importId, workstations: node });
          times += 1;
          this.setState({
    ...
    <div style={{ height: 240 }}>
      <div className={styles.stepOneWrapper}>
        <div className="import-steps">
          <p>操作步骤:</p>
          <p>
            1.下载<a href="https://s3.cn-northwest-1.amazonaws.com.cn/public-template/%E5%AF%BC%E5%85%A5%E5%B7%A5%E4%BD%8D%E6%A8%A1%E6%9D%BF.csv">
              《导入工位模板》
            </a>
          </p>
        ...
        <div className={styles.upload}>
          ...
          >
            <span style={{ fontSize: 14, marginRight: 10 }}>工位</span>
      ...
      <div className={styles.importTip}>
        ...
        <div className={styles.bottom}>
          <Button
            type="default"
            onClick={() => {
              this.context.router.history.push(`/knowledgeManagement/workstation/import-log/${importId}`);
            }}
          >
            导入日志
          </Button>
