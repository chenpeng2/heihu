    ...
    return (
      ...
      >
        <ItemList>
          ...
          <Item label="成品物料编号/名称">
            {getFieldDecorator('projectProductCode')(<SearchSelect type="materialBySearch" params={{ status: 1 }} />)}
          </Item>
          <Item label="产出物料">
          ...
          <Item label="优先标记">{getFieldDecorator('priority')(<SearchSelect type="taskPriority" />)}</Item>
        </ItemList>
        {this.getButton()}
      </FilterSortSearchBar>
    );
