...
import { withForm, Tooltip, Form, FormItem, Input, Button, SimpleTable } from 'components';
...
class AuditNotPassReasonModal extends Component<Props> {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <Form>
          <FormItem label="审批备注">{getFieldDecorator('remark', {})(<TextArea autosize={{ minRows: 1, maxRows: 8 }} />)}</FormItem>
