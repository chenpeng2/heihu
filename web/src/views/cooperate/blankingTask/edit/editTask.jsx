            ...
            <ConflictAlert
              ...
              onOk={async () => {
                ...
                if (isModal) {
                  ...
                  this.context.router.history.push(`/cooperate/blankingTasks/detail/${id}`);
                }
              }}
            />
          ),
              ...
              <Button
                ...
                onClick={() => {
                  if (isModal) {
                    ...
                    this.context.router.history.push('/cooperate/blankingTasks');
                  }
                  if (onCancel) {
                    onCancel();
                  }
...
function EditTask(props: any) {
  return (
    <div>
      <p style={{ margin: 20, fontSize: 14 }}>{changeChineseToLocale('编辑下料任务', props.intl)}</p>
      <div style={{ marginLeft: 40 }}>
