    ...
    return [
      {
        ...
        dataIndex: 'type',
        render: data => {
          const { name } = findOutStorageTypes(data) || {};
      ...
      },
      {
        ...
        width: 150,
        render: (__, record) => {
          const { targetWarehouseCode, targetWarehouseName } = record || {};
          return (
            <div>
              <div>
                <Tooltip text={targetWarehouseCode || replaceSign} width={150} />
              </div>
              <div>
                <Tooltip text={targetWarehouseName || replaceSign} width={150} />
              </div>
            </div>
          );
        },
      ...
      },
      {
        ...
        render: data => {
          return <Tooltip text={data || replaceSign} width={80} />;
        },
      },
      signStatus && {
        title: '电子签名人',
