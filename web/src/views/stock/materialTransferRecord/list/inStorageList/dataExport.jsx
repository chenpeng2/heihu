...
class DataExport extends Component {
  ...
  dataExport = () => {
    ...
    const query = _.get(queryObj, 'table2.query');
  ...
  formatExportData = data => {
    ...
    const _data = data.map(x => {
      ...
      const _type = findInStorageTypes(type);
