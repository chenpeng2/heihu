...
import { getQcDefectRankImportList } from 'src/services/knowledgeBase/qcModeling/qcDefectRank';
import { setLocation } from 'utils/url';
import { getQcDefectRankImportLogDetailUrl } from '../utils';
...
const ImportLog = (props: Props) => {
        ...
        render: (data, record) => (
          <div key={`code-${record.id}`}>
            <Link
              ...
              onClick={() => {
                history.push(getQcDefectRankImportLogDetailUrl(record.importId));
              }}
            >
              查看
            </Link>
  ...
  const fetchData = async values => {
    ...
    getQcDefectRankImportList(values)
      .then(res => {
