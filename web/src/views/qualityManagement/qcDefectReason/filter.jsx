...
import { QCDEFECT_REASON_STATUS } from './constants';
...
const Filter = (props: Props) => {
  ...
  return (
    <FilterSortSearchBar style={{ width: '100%', borderBottom: `1px solid ${borderGrey}` }}>
      <ItemList>
        <Item label="状态">
          {getFieldDecorator('searchStatus', { initialValue: QCDEFECT_REASON_STATUS.all })(
            <Select labelInValue>
              {Object.values(QCDEFECT_REASON_STATUS).map(({ key, label }) => (
