...
import { getQcConfigImportList } from 'src/services/qcConfig';
import { setLocation } from 'utils/url';
import { getQcConfigImportLogDetailUrl } from '../../utils';
    ...
    const columns = [
      ...
      },
      {
        ...
        render: (text, record) => (
          ...
          >
            {'质检方案导入完成！成功数：{amountSuccess}，失败数：{amountFailed}'}
          </Text>
        ),
      },
      {
        ...
        render: (data, record) => (
          <div key={`code-${record.id}`}>
            <Link
              ...
              onClick={() => {
                history.push(getQcConfigImportLogDetailUrl(record.importId));
              }}
            >
              查看
            </Link>
