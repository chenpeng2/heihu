...
import { getRepairTaskList } from 'src/services/equipmentMaintenance/repairTask';
import log from 'src/utils/log';
import Filter from './filter';
import List from './list';
import { getCreateRepairTaskUrl } from '../utils';
...
const DeviceRepairTask = (props: Props) => {
    ...
    <div>
      ...
      <div style={{ margin: '20px 0 20px 20px' }}>
        <Button
          icon="plus-circle-o"
          onClick={() => {
            history.push(getCreateRepairTaskUrl('device'));
          }}
        >
          创建维修任务
        </Button>
...
export default withRouter(DeviceRepairTask);
