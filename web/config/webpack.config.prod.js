        ...
        CONF: JSON.stringify(
          Object.assign(
            {},
            {
              ...
              ENV: process.env.GC_NODE_ENV,
              BUILD_AT: moment().format(),
            },
            appConf[process.env.GC_NODE_ENV || 'dev'], // 这个是根据环境来决定对应CONF的地方。
            process.env.URL ? { API: process.env.URL } : {}, // 这个地方决定了如果build的时候传了api那么使用api。会覆盖CONF中的api
          ),
        ),
      }),
    ),
