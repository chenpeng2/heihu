...
const appConf = yaml.safeLoad(fs.readFileSync(paths.conf, 'utf8'));
...
const shouldDisabledEslint = process.argv.indexOf('disable-eslint') !== -1;
...
module.exports = {
  ...
  output: {
    ...
    // TODO: HGF
    // chunkFilename: `static/js/[name].${moment().format('YYYY-MM-DD-hh-mm')}.chunk.js`,
  ...
  resolve: {
    ...
    alias: {
      ...
      'react-dom': '@hot-loader/react-dom', // 对hook的支持 https://github.com/gaearon/react-hot-loader
    },
    plugins: [
          ...
          // extensions .module.scss or .module.sass
          {
            ...
            use: [
              ...
              },
              {
                ...
                options: {
                  syntax: 'scss',
                  files: [path.resolve(__dirname, '../src/styles/color/index.js')],
                },
              },
            ],
          },
        ...
        CONF: JSON.stringify(
          Object.assign(
            {},
            {
              ...
              BUILD_AT: moment().format(),
            },
            appConf[process.env.NODE_ENV],
          ),
        ),
      }),
    ),
